...
//               </span>
//             </span>
//             {userRole == "User" || !form.projectid ? null : (
//               <ProjectAssignScreen
...
//                       onChange={(e) =>
//                         handleChange({ ...form, projectname: e.target.value })
//                       }
//                     />
//                   </div>
//                   <div className="w-full sm:w-1/4">
...
//                       onChange={(e) =>
//                         handleChange({ ...form, startdate: e.target.value })
//                       }
//                     />
//                   </div>
//                   <div className="w-full sm:w-1/4">
...
//                       value={form.enddate}
//                       onChange={(e) =>
//                         handleChange({ ...form, enddate: e.target.value })
//                       }
//                     />
//                   </div>
//                   <div className="w-full sm:w-1/4">
